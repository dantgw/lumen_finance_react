...
import { ClaimLoanContractInteraction } from '@/components/web3/ClaimLoanContractInteraction'
import { RepayLoanContractInteraction } from '@/components/web3/RepayLoanContractInteraction'
const inter = Inter({ subsets: ["latin"] });


const ClaimLoanPage: NextPage = () => {
