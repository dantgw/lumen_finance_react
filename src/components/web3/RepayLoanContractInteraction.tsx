...
export const RepayLoanContractInteraction: FC = () => {
      ...
      if (!currentChain) {
        ...
        try {
          ...
          if (result2.status == "SUCCESS") {
            toast.success("Loan Repaid Success!")
          }
          else {
            toast.error("Loan Repaid unsuccessful...")
  ...
  return (
        ...
        <h2 tw="text-center text-2xl font-semibold text-black">Repay Loan</h2>
          
          <form onSubmit={handleSubmit(claimLoan)}>
